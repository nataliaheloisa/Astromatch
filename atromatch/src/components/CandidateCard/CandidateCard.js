...
export default function CandidateCard() {
  ...
  const getProfile = () => {
    axios
      .get(
        "https://us-central1-missao-newton.cloudfunctions.net/astroMatch/natalia-amaral/person"
      )
      .then((response) => {
  ...
  const choosePerson = (value) => {
    ...
    axios
      .post(
        "https://us-central1-missao-newton.cloudfunctions.net/astroMatch/natalia-amaral/choose-person",
        body
      )
      .then((response) => {
        getProfile();
